<template>
    ...
    <q-card-selection class="row text-center">
        <q-card-selection class="col text-h4 text-primary">
            {{ header || "welcom" }}
            <q-btn
                v-if="editing"
                @click="doEdit(false)"
    ...
    <q-card-section class = "row justify-center">
        <q-card-selection v-if="editing" class="col-8 col-md-3">
            <q-input
                v-model="newItem"
        ...
        <q-card-selection v-if="editing" class="col-4 col-md-3">
            <q-checkbox
                class="q-pa-none"
    ...
    <q-card-section>
        <q-list bordered>
            <q-item
                ...
                :class="{strikeout:item.purchased,prioity:item.highPriority}"
                dense
                padding
                clickable
                v-ripple
